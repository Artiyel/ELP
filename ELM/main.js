...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{affichersolu: false, input: '', mot: 'ELM', title: 'Guess It!'},
...
var $author$project$Main$Afficher = {$: 'Afficher'};
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'margin-left', '540px')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('Try to guess the word...'),
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin-bottom', '20px'),
						A2($elm$html$Html$Attributes$style, 'margin-left', '560px')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$Afficher)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Afficher la solution')
							]))
					]))
			]));
};
